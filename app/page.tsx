  ...
  return (
    <main className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <section className="mb-8 sm:mb-10">
        ...
        <div className="border border-gray-600 rounded p-3 mb-3 bg-gray-50 max-w-5xl mx-auto">
          <img src="/diagram.png" alt="SARIMAX Pipeline Process Flow" className="w-full max-w-4xl mx-auto rounded mb-2" />
          <p className="text-xs text-gray-500 italic">Professional SARIMAX pipeline diagram showing the complete workflow from raw data to business-ready forecasts</p>
        </div>
        <p className="text-xs text-gray-600 mb-3"><strong>The complete process:</strong> This diagram shows the end-to-end workflow we'll walk through step by step below. Each stage transforms the data to make it suitable for accurate forecasting.</p>
      </section>
...
plt.show()`}</pre>
        ...
        <p className="text-xs text-gray-600 mb-3"><strong>Understanding seasonality:</strong> Social media engagement follows predictable seasonal patterns - holidays drive spikes (December, February, June), while transition periods see lower activity. The seasonal decomposition above shows how our model learns to identify and predict these yearly cycles.</p>
      </section>
